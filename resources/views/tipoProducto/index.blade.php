                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modal1Title">Nuevo Tipo</h5>
                            <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                        </div>

                        <div class="modal-body">
                            <form action="/tipos_productos/store" method="POST">
                                @csrf
                                <div class="d-flex flex-row  justify-content-between flex-wrap flex-md-nowrap ">
                                    <div class="form-group col-12 p-2">
                                        <input type="text" class="form-control" name="nombre_tipo_producto"
                                            id="nombre_tipo_producto" placeholder="Nombre del tipo de Producto">
                                    </div>
                                </div>
                                {{-- <div class="form-group col-12 p-2">
